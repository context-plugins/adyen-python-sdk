...
| `merchant_id` | `str` | Required | The unique identifier of the merchant account that the store belongs to. |
...
from adyen.models.store_creation_with_merchant_code_request import StoreCreationWithMerchantCodeRequest
from adyen.models.store_split_configuration import StoreSplitConfiguration

store_creation_with_merchant_code_request = StoreCreationWithMerchantCodeRequest(
    address=Address15(
        country='country0',
        city='city6',
        line_1='line18',
