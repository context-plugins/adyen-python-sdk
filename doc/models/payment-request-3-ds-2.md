...
| `three_ds_2_result` | [`ThreeDS2Result`](../../doc/models/three-ds-2-result.md) | Optional | The ThreeDS2Result that was returned in the final CRes. |
| `three_ds_2_token` | `str` | Optional | The ThreeDS2Token that was returned in the /authorise call. |
...
from adyen.models.payment_request_3_ds_2 import PaymentRequest3ds2

payment_request_3_ds_2 = PaymentRequest3ds2(
    amount=Amount(
        currency='currency2',
        value=110
    ),
