...
acct_info_1 = AcctInfo1(
    ch_acc_age_ind=ChAccAgeInd.ENUM_03,
    ch_acc_change='chAccChange6',
    ch_acc_change_ind=ChAccChangeInd.ENUM_03,
    ch_acc_pw_change='chAccPwChange4',
    ch_acc_pw_change_ind=ChAccPwChangeInd.ENUM_01,
