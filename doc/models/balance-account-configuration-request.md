...
# Balance Account Configuration Request
...
|  --- | --- | --- | --- |
| `balance_platform_payout_schedule_id` | `str` | Required | The unique identifier of the payout schedule that is applied to the balance account. |
...
| `frequency` | [`Frequency1Enum`](../../doc/models/frequency-1-enum.md) | Required | The frequency of payouts initiated by this payout schedule.<br><br>Possible values:<br><br>* daily<br>* weekdays<br>* weekly<br>* monthly<br><br>Default value: The `defaultFrequency` from the balance platform schedule that you are applying. |
...
```python
from adyen.models.balance_account_configuration_request import BalanceAccountConfigurationRequest
from adyen.models.frequency_1_enum import Frequency1Enum

balance_account_configuration_request = BalanceAccountConfigurationRequest(
    balance_platform_payout_schedule_id='balancePlatformPayoutScheduleId0',
    frequency=Frequency1Enum.DAILY,
    transfer_instrument_id='transferInstrumentId2',
    currency='currency0',
    description='description0',
    enabled=False,
    frequency_value=80,
    max_payout_amount=52
)
```
