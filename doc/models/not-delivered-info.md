...
| `what_was_not_delivered` | [`ProductType21Enum`](../../doc/models/product-type-21-enum.md) | Required | The type of product that you expected to receive.<br><br>Possible values: **goods**, **services**. |
| `who_cancelled` | [`CancellingEntity1Enum`](../../doc/models/cancelling-entity-1-enum.md) | Optional | The party that initiated the cancellation of the transaction.<br><br>Possible values: **merchant**, **cardholder**. |
