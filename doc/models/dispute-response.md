...
| `other_info` | [`OtherInfo1`](../../doc/models/other-info-1.md) | Optional | Additional information for raising a dispute of `type` **other**. Required for disputes of `type` **other**<br><br>**Note:** The **other** dispute `type` is currently in beta testing. Do not create or submit any disputes for this dispute `type` at this time. |
