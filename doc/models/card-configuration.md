...
| `bulk_address` | [`BulkAddress1`](../../doc/models/bulk-address-1.md) | Optional | Overrides the shipment bulk address defined in the card configuration profile. |
...
card_configuration = CardConfiguration(
    configuration_profile_id='configurationProfileId0',
    activation='activation6',
    activation_url='activationUrl2',
