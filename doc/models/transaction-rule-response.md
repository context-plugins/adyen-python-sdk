...
|  --- | --- | --- | --- |
| `transaction_rule` | [`TransactionRule1`](../../doc/models/transaction-rule-1.md) | Optional | The transaction rule. |
...
from adyen.models.transaction_rule_1 import TransactionRule1
...
transaction_rule_response = TransactionRuleResponse(
    transaction_rule=TransactionRule1(
