...
| `addr_match` | [`AddrMatch`](../../doc/models/addr-match.md) | Optional | **Constraints**: *Minimum Length*: `1`, *Maximum Length*: `1` |
...
| `three_ds_requestor_challenge_ind` | [`ThreeDsReqAuthMethod`](../../doc/models/three-ds-req-auth-method.md) | Optional | - |
...
from adyen.models.addr_match import AddrMatch
...
from adyen.models.three_ds_2_request_data_11 import ThreeDs2RequestData11

three_ds_2_request_data_11 = ThreeDs2RequestData11(
    device_channel='deviceChannel6',
    acct_info=AcctInfo1(
    ...
    acct_type=AcctType.ENUM_03,
    acquirer_bin='acquirerBIN2',
    acquirer_merchant_id='acquirerMerchantID0',
    addr_match=AddrMatch.Y,
