...
| `modification_amount` | [`ModificationAmount`](../../doc/models/modification-amount.md) | Optional | - |
| `mpi_data` | [`MpiData`](../../doc/models/mpi-data.md) | Optional | - |
| `original_merchant_reference` | `str` | Required | The original merchant reference to cancel. |
...
from adyen.models.technical_cancel_request import TechnicalCancelRequest

technical_cancel_request = TechnicalCancelRequest(
