...
| `mtype` | [`Type57Enum`](../../doc/models/type-57-enum.md) | Optional | **wechatpayMiniProgram**<br><br>**Default**: `"wechatpayMiniProgram"` |

## Example

```python
from adyen.models.type_57_enum import Type57Enum
