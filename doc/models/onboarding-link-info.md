...
| `settings` | [`OnboardingLinkSettings2`](../../doc/models/onboarding-link-settings-2.md) | Optional | Key-value pairs indicating the settings for the hosted onboarding page. The key represents a specific setting. |
...
from adyen.models.onboarding_link_settings_2 import OnboardingLinkSettings2

onboarding_link_info = OnboardingLinkInfo(
    locale='locale4',
    redirect_url='redirectUrl0',
    settings=OnboardingLinkSettings2(
        accepted_countries=[
            'acceptedCountries9',
            'acceptedCountries0'
        ],
