...
| `counterparty` | [`SweepCounterparty1`](../../doc/models/sweep-counterparty-1.md) | Required | The destination or the source of the funds, depending on the sweep `type`.<br><br>Either a `balanceAccountId`, `transferInstrumentId`, or `merchantAccount` is required. |
...
| `schedule` | [`SweepSchedule1`](../../doc/models/sweep-schedule-1.md) | Required | The schedule when the `triggerAmount` is evaluated. If the balance meets the threshold, funds are pushed out of or pulled in to the balance account. |
...
from adyen.models.create_sweep_configuration_v_2 import CreateSweepConfigurationV2
...
create_sweep_configuration_v_2 = CreateSweepConfigurationV2(
