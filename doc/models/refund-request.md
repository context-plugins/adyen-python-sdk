...
| `modification_amount` | [`Amount`](../../doc/models/amount.md) | Required | The amount that needs to be refunded. The `currency` must match the currency used in authorisation, the `value` must be smaller than or equal to the authorised amount. |
...
from adyen.models.refund_request import RefundRequest
