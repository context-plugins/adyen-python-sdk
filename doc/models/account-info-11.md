...
| `delivery_address_usage_indicator` | [`AccountChangeIndicator`](../../doc/models/account-change-indicator.md) | Optional | - |
...
| `password_change_indicator` | [`AccountAgeIndicator`](../../doc/models/account-age-indicator.md) | Optional | - |
...
| `payment_account_indicator` | [`AccountAgeIndicator`](../../doc/models/account-age-indicator.md) | Optional | - |
...
from adyen.models.account_info_11 import AccountInfo11
from adyen.models.account_type_1 import AccountType1

account_info_11 = AccountInfo11(
    account_age_indicator=AccountAgeIndicator.THISTRANSACTION,
    account_change_date=dateutil.parser.parse('2016-03-13T12:52:32.123Z'),
    account_change_indicator=AccountChangeIndicator.FROM30TO60DAYS,
