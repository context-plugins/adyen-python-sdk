...
| `modification_amount` | [`Amount`](../../doc/models/amount.md) | Required | The currency and value of the new total amount in minor units. For example, to increase the amount, the value is the sum of the pre-authorized amount and the additional amount. |
...
```python
from adyen.models.adjust_authorisation_request import AdjustAuthorisationRequest
...
adjust_authorisation_request = AdjustAuthorisationRequest(
    ...
    original_merchant_reference='originalMerchantReference4',
