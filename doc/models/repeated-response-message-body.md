...
|  --- | --- | --- | --- |
| `loyalty_response` | [`LoyaltyResponse`](../../doc/models/loyalty-response.md) | Optional | It conveys Information related to the Loyalty transaction processed by the POI System.<br>Content of the Loyalty Response message. |
| `payment_response` | [`PaymentResponse4`](../../doc/models/payment-response-4.md) | Optional | It conveys Information related to the Payment transaction processed by the POI System.<br>Content of the Payment Response message. |
| `reversal_response` | [`ReversalResponse`](../../doc/models/reversal-response.md) | Optional | It conveys Information related to the reversal processed by the POI System.<br>Content of the Reversal Response message. |
| `stored_value_response` | [`StoredValueResponse`](../../doc/models/stored-value-response.md) | Optional | It conveys Information related to the Stored Value transaction processed by the POI System.<br>Content of the Stored Value Response message. |
| `card_acquisition_response` | [`CardAcquisitionResponse`](../../doc/models/card-acquisition-response.md) | Optional | It conveys Information related to the payment and loyalty cards read and processed by the POI System and entered by the Customer.<br>Content of the Card Acquisition Response message. |
| `card_reader_apdu_response` | [`CardReaderAPDUResponse`](../../doc/models/card-reader-apdu-response.md) | Optional | Content of the Card Reader APDU Response message.<br>It contains the result of the requested service, APDU response sent by the chip of the card in response to the APDU request. |
