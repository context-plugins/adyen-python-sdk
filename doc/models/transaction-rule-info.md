...
from adyen.models.transaction_rule_info import TransactionRuleInfo
...
transaction_rule_info = TransactionRuleInfo(
    ...
    mtype=Type141Enum.ALLOWLIST,
    aggregation_level='aggregationLevel2',
    end_date='endDate2',
    outcome_type=OutcomeTypeEnum.ENFORCESCA,
    overrides_rule='overridesRule6',
