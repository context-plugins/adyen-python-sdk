...
| `routing_details` | [`List[RoutingDetails]`](../../doc/models/routing-details.md) | Optional | Detailed explanation of each attempt to route the transfer with the priorities from the request. |
