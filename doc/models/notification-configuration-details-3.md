...
# Notification Configuration Details 3

Details of the notification subscription configuration to be updated.

## Structure

`NotificationConfigurationDetails3`
...
notification_configuration_details_3 = NotificationConfigurationDetails3(
    active=False,
    api_version=152,
    ...
    hmac_signature_key='hmacSignatureKey0'
)
```
