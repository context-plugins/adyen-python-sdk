...
# Stored Value Status Change Response
...
from adyen.models.stored_value_status_change_response import StoredValueStatusChangeResponse

stored_value_status_change_response = StoredValueStatusChangeResponse(
    auth_code='authCode6',
