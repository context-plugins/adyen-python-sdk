...
| `entity_type` | [`ScaEntityType3Enum`](../../doc/models/sca-entity-type-3-enum.md) | Required | The type of the entity.<br><br>Possible values: **accountHolder**, **legalEntity** or **paymentInstrument**. |
...
from adyen.models.sca_entity_type_3_enum import ScaEntityType3Enum

remove_association_request = RemoveAssociationRequest(
    entity_id='entityId6',
    entity_type=ScaEntityType3Enum.LEGALENTITY,
    sca_device_ids=[
        'scaDeviceIds0',
        'scaDeviceIds1'
    ]
