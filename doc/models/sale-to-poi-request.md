...
| `abort_request` | [`AbortRequest2`](../../doc/models/abort-request-2.md) | Optional | Content of the Abort Request message. |
| `balance_inquiry_request` | [`BalanceInquiryRequest2`](../../doc/models/balance-inquiry-request-2.md) | Optional | Content of the Balance Inquiry Request message. |
| `card_acquisition_request` | [`CardAcquisitionRequest2`](../../doc/models/card-acquisition-request-2.md) | Optional | Content of the Card Acquisition Request message. |
| `admin_request` | [`AdminRequest2`](../../doc/models/admin-request-2.md) | Optional | Content of the Admin Request message. |
| `diagnosis_request` | [`DiagnosisRequest2`](../../doc/models/diagnosis-request-2.md) | Optional | Content of the Diagnosis Request message. |
| `display_request` | [`DisplayRequest2`](../../doc/models/display-request-2.md) | Optional | Content of the Display Request message. |
| `enable_service_request` | [`EnableServiceRequest2`](../../doc/models/enable-service-request-2.md) | Optional | Content of the Enable Service Request message. |
| `event_notification` | [`EventNotification2`](../../doc/models/event-notification-2.md) | Optional | Content of the EventNotification message. |
| `get_totals_request` | [`GetTotalsRequest2`](../../doc/models/get-totals-request-2.md) | Optional | Content of the Get Totals Request message. |
| `input_request` | [`InputRequest2`](../../doc/models/input-request-2.md) | Optional | Content of the Input Request message. |
| `input_update` | [`InputUpdate2`](../../doc/models/input-update-2.md) | Optional | Content of the Input Update message. |
| `login_request` | [`LoginRequest2`](../../doc/models/login-request-2.md) | Optional | Content of the Login Request message. |
| `logout_request` | [`LogoutRequest2`](../../doc/models/logout-request-2.md) | Optional | Content of the Logout Request message. |
| `payment_request` | [`PaymentRequest21`](../../doc/models/payment-request-21.md) | Optional | Content of the Payment Request message. |
| `print_request` | [`PrintRequest2`](../../doc/models/print-request-2.md) | Optional | Content of the Print Request message. |
| `card_reader_apdu_request` | [`CardReaderAPDURequest2`](../../doc/models/card-reader-apdu-request-2.md) | Optional | Content of the Card Reader APDU Request message. |
| `reconciliation_request` | [`ReconciliationRequest2`](../../doc/models/reconciliation-request-2.md) | Optional | Content of the Reconciliation Request message. |
| `reversal_request` | [`ReversalRequest2`](../../doc/models/reversal-request-2.md) | Optional | Content of the Reversal Request message. |
| `stored_value_request` | [`StoredValueRequest2`](../../doc/models/stored-value-request-2.md) | Optional | Content of the Stored Value Request message. |
| `transaction_status_request` | [`TransactionStatusRequest2`](../../doc/models/transaction-status-request-2.md) | Optional | Content of the TransactionStatus Request message. |
