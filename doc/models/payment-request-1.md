...
| `bank_account` | [`BankAccount9`](../../doc/models/bank-account-9.md) | Optional | - |
...
| `fund_destination` | [`FundDestination`](../../doc/models/fund-destination.md) | Optional | - |
...
| `secure_remote_commerce_checkout_data` | [`SecureRemoteCommerceCheckoutData`](../../doc/models/secure-remote-commerce-checkout-data.md) | Optional | - |
