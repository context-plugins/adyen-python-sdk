...
| `merchant` | [`TransferNotificationMerchantData`](../../doc/models/transfer-notification-merchant-data.md) | Optional | - |
...
from adyen.models.transfer_notification_counter_party import TransferNotificationCounterParty
...
transfer_notification_counter_party = TransferNotificationCounterParty(
