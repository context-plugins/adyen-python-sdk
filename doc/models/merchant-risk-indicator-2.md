...
| `gift_card_amount` | [`Amount`](../../doc/models/amount.md) | Optional | For prepaid or gift card purchase, the purchase amount total of prepaid or gift card(s). |
...
from adyen.models.merchant_risk_indicator_2 import MerchantRiskIndicator2

merchant_risk_indicator_2 = MerchantRiskIndicator2(
    address_match=False,
    delivery_address_indicator=DeliveryAddressIndicatorEnum.SHIPTOSTORE,
    delivery_email='deliveryEmail0',
    delivery_email_address='deliveryEmailAddress0',
