...
```python
from adyen.models.checkout_session_three_ds_2_request_data import CheckoutSessionThreeDS2RequestData
...
checkout_session_three_ds_2_request_data = CheckoutSessionThreeDS2RequestData(
    home_phone=Phone3(
        cc='cc0',
    ...
    three_ds_requestor_challenge_ind=ThreeDSRequestorChallengeIndEnum.ENUM_05,
    work_phone=Phone2(
        cc='cc2',
