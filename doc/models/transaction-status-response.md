...
| `message_reference` | [`MessageReference3`](../../doc/models/message-reference-3.md) | Optional | Identification of a previous POI transaction.<br>If `Response.Result` is Success. |
| `repeated_message_response` | [`RepeatedMessageResponse2`](../../doc/models/repeated-message-response-2.md) | Optional | Content of the requested Message Response.<br>If Result is Success (process completed). |
...
from adyen.models.repeated_message_response_2 import RepeatedMessageResponse2
...
from adyen.models.transaction_status_response import TransactionStatusResponse
...
transaction_status_response = TransactionStatusResponse(
    ...
    message_reference=MessageReference3(
    ...
    repeated_message_response=RepeatedMessageResponse2(
