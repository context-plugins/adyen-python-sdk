...
| `payment_method` | `Dict[str, str]` | Required | The collection that contains the type of the payment method and its specific information. |
...
| `three_ds_2_request_data` | [`ThreeDs2RequestData`](../../doc/models/three-ds-2-request-data.md) | Optional | - |
...
from adyen.models.balance_check_request import BalanceCheckRequest
...
balance_check_request = BalanceCheckRequest(
    amount=Amount16(
        currency='currency2',
        value=110,
