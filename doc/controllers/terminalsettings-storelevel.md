...
```python
def get_merchants_merchant_id_stores_reference_terminal_logos(self,
                                                             merchant_id,
                                                             reference,
                                                             model)
```
...
| `reference` | `str` | Template, Required | The reference that identifies the store. |
| `model` | `str` | Query, Required | The terminal model. Possible values: E355, VX675WIFIBT, VX680, VX690, VX700, VX820, M400, MX925, P400Plus, UX300, UX410, V200cPlus, V240mPlus, V400cPlus, V400m, e280, e285, e285p, S1E, S1EL, S1F2, S1L, S1U, S7T. |
...
```python
def patch_merchants_merchant_id_stores_reference_terminal_logos(self,
                                                               merchant_id,
                                                               reference,
                                                               model,
                                                               body=None)
...
```python
def get_merchants_merchant_id_stores_reference_terminal_settings(self,
                                                                merchant_id,
                                                                reference)
```
...
```python
def patch_merchants_merchant_id_stores_reference_terminal_settings(self,
                                                                  merchant_id,
                                                                  reference,
                                                                  body=None)
```
...
```python
def get_stores_store_id_terminal_logos(self,
                                      store_id,
                                      model)
```
...
```python
def patch_stores_store_id_terminal_logos(self,
                                        store_id,
                                        model,
                                        body=None)
```
...
```python
def get_stores_store_id_terminal_settings(self,
                                         store_id)
```
...
```python
def patch_stores_store_id_terminal_settings(self,
                                           store_id,
                                           body=None)
```
