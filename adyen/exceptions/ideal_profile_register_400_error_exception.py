...
class IdealProfileRegister400ErrorException(ApiException):
    def __init__(self, reason, response):
        """Initialize IdealProfileRegister400ErrorException object.
        ...
        """
        super(IdealProfileRegister400ErrorException, self).__init__(reason, response)
