...
class AuthCertificate401ErrorException(ApiException):
    def __init__(self, reason, response):
        """Initialize AuthCertificate401ErrorException object.
        ...
        """
        super(AuthCertificate401ErrorException, self).__init__(reason, response)
