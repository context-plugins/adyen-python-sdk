...
class ScaDevices403ErrorException(ApiException):
    def __init__(self, reason, response):
        """Initialize ScaDevices403ErrorException object.
        ...
        """
        super(ScaDevices403ErrorException, self).__init__(reason, response)
