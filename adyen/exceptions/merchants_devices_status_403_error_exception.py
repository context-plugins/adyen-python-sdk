...
class MerchantsDevicesStatus403ErrorException(ApiException):
    def __init__(self, reason, response):
        """Initialize MerchantsDevicesStatus403ErrorException object.
        ...
        """
        super(MerchantsDevicesStatus403ErrorException, self).__init__(reason, response)
