...
class ServiceErrorError1Exception(APIException):
    def __init__(self, reason, response):
        """Initialize ServiceErrorError1Exception object.
        ...
        """
        super(ServiceErrorError1Exception, self).__init__(reason, response)
