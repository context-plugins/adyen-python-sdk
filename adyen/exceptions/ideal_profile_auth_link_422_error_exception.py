...
class IdealProfileAuthLink422ErrorException(ApiException):
    def __init__(self, reason, response):
        """Initialize IdealProfileAuthLink422ErrorException object.
        ...
        """
        super(IdealProfileAuthLink422ErrorException, self).__init__(reason, response)
