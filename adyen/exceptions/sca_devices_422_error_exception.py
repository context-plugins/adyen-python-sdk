...
class ScaDevices422ErrorException(ApiException):
    def __init__(self, reason, response):
        """Initialize ScaDevices422ErrorException object.
        ...
        """
        super(ScaDevices422ErrorException, self).__init__(reason, response)
