...
class MandatesCancel401ErrorException(ApiException):
    def __init__(self, reason, response):
        """Initialize MandatesCancel401ErrorException object.
        ...
        """
        super(MandatesCancel401ErrorException, self).__init__(reason, response)
