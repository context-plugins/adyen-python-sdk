...
class MerchantsDevicesStatus401ErrorException(ApiException):
    def __init__(self, reason, response):
        """Initialize MerchantsDevicesStatus401ErrorException object.
        ...
        """
        super(MerchantsDevicesStatus401ErrorException, self).__init__(reason, response)
