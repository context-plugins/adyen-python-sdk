...
class PaymentsConfirm500ErrorException(ApiException):
    def __init__(self, reason, response):
        """Initialize PaymentsConfirm500ErrorException object.
        ...
        """
        super(PaymentsConfirm500ErrorException, self).__init__(reason, response)
