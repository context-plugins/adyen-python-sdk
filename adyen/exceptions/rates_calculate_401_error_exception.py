...
class RatesCalculate401ErrorException(ApiException):
    def __init__(self, reason, response):
        """Initialize RatesCalculate401ErrorException object.
        ...
        """
        super(RatesCalculate401ErrorException, self).__init__(reason, response)
