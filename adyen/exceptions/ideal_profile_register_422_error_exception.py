...
class IdealProfileRegister422ErrorException(ApiException):
    def __init__(self, reason, response):
        """Initialize IdealProfileRegister422ErrorException object.
        ...
        """
        super(IdealProfileRegister422ErrorException, self).__init__(reason, response)
