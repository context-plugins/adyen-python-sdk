...
class MandatesCancel403ErrorException(ApiException):
    def __init__(self, reason, response):
        """Initialize MandatesCancel403ErrorException object.
        ...
        """
        super(MandatesCancel403ErrorException, self).__init__(reason, response)
