...
class MerchantsPaymentsApps422ErrorException(ApiException):
    def __init__(self, reason, response):
        """Initialize MerchantsPaymentsApps422ErrorException object.
        ...
        """
        super(MerchantsPaymentsApps422ErrorException, self).__init__(reason, response)
