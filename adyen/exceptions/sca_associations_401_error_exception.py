...
class ScaAssociations401ErrorException(ApiException):
    def __init__(self, reason, response):
        """Initialize ScaAssociations401ErrorException object.
        ...
        """
        super(ScaAssociations401ErrorException, self).__init__(reason, response)
