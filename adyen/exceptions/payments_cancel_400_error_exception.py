...
class PaymentsCancel400ErrorException(ApiException):
    def __init__(self, reason, response):
        """Initialize PaymentsCancel400ErrorException object.
        ...
        """
        super(PaymentsCancel400ErrorException, self).__init__(reason, response)
