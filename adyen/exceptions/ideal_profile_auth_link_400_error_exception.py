...
class IdealProfileAuthLink400ErrorException(ApiException):
    def __init__(self, reason, response):
        """Initialize IdealProfileAuthLink400ErrorException object.
        ...
        """
        super(IdealProfileAuthLink400ErrorException, self).__init__(reason, response)
