...
class ScaDevices500ErrorException(ApiException):
    def __init__(self, reason, response):
        """Initialize ScaDevices500ErrorException object.
        ...
        """
        super(ScaDevices500ErrorException, self).__init__(reason, response)
