...
class PaymentsDetails500ErrorException(ApiException):
    def __init__(self, reason, response):
        """Initialize PaymentsDetails500ErrorException object.
        ...
        """
        super(PaymentsDetails500ErrorException, self).__init__(reason, response)
