...
class AuthCertificate400ErrorException(ApiException):
    def __init__(self, reason, response):
        """Initialize AuthCertificate400ErrorException object.
        ...
        """
        super(AuthCertificate400ErrorException, self).__init__(reason, response)
