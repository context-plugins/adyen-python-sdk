...
class PaymentsCancel422ErrorException(ApiException):
    def __init__(self, reason, response):
        """Initialize PaymentsCancel422ErrorException object.
        ...
        """
        super(PaymentsCancel422ErrorException, self).__init__(reason, response)
