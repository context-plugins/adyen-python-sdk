...
class MerchantsPaymentsApps403ErrorException(ApiException):
    def __init__(self, reason, response):
        """Initialize MerchantsPaymentsApps403ErrorException object.
        ...
        """
        super(MerchantsPaymentsApps403ErrorException, self).__init__(reason, response)
