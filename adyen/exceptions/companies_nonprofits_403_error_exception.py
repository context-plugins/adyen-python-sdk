...
class CompaniesNonprofits403ErrorException(ApiException):
    def __init__(self, reason, response):
        """Initialize CompaniesNonprofits403ErrorException object.
        ...
        """
        super(CompaniesNonprofits403ErrorException, self).__init__(reason, response)
