...
class ScaDevices401ErrorException(ApiException):
    def __init__(self, reason, response):
        """Initialize ScaDevices401ErrorException object.
        ...
        """
        super(ScaDevices401ErrorException, self).__init__(reason, response)
