...
class ScaAssociations500ErrorException(ApiException):
    def __init__(self, reason, response):
        """Initialize ScaAssociations500ErrorException object.
        ...
        """
        super(ScaAssociations500ErrorException, self).__init__(reason, response)
