...
class GrantOffers422Error3Exception(ApiException):
    def __init__(self, reason, response):
        """Initialize GrantOffers422Error3Exception object.
        ...
        """
        super(GrantOffers422Error3Exception, self).__init__(reason, response)
