...
class PaymentsCancel500ErrorException(ApiException):
    def __init__(self, reason, response):
        """Initialize PaymentsCancel500ErrorException object.
        ...
        """
        super(PaymentsCancel500ErrorException, self).__init__(reason, response)
