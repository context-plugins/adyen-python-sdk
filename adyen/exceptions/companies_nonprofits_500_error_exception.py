...
class CompaniesNonprofits500ErrorException(ApiException):
    def __init__(self, reason, response):
        """Initialize CompaniesNonprofits500ErrorException object.
        ...
        """
        super(CompaniesNonprofits500ErrorException, self).__init__(reason, response)
