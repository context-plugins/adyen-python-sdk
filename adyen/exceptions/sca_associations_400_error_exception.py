...
class ScaAssociations400ErrorException(ApiException):
    def __init__(self, reason, response):
        """Initialize ScaAssociations400ErrorException object.
        ...
        """
        super(ScaAssociations400ErrorException, self).__init__(reason, response)
