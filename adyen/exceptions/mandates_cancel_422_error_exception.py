...
class MandatesCancel422ErrorException(ApiException):
    def __init__(self, reason, response):
        """Initialize MandatesCancel422ErrorException object.
        ...
        """
        super(MandatesCancel422ErrorException, self).__init__(reason, response)
