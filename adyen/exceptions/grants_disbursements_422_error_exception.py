...
class GrantsDisbursements422ErrorException(ApiException):
    def __init__(self, reason, response):
        """Initialize GrantsDisbursements422ErrorException object.
        ...
        """
        super(GrantsDisbursements422ErrorException, self).__init__(reason, response)
