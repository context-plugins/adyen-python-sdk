...
class IdealProfileAuthenticate500ErrorException(ApiException):
    def __init__(self, reason, response):
        """Initialize IdealProfileAuthenticate500ErrorException object.
        ...
        """
        super(IdealProfileAuthenticate500ErrorException,
