...
class PaymentsConfirm400ErrorException(ApiException):
    def __init__(self, reason, response):
        """Initialize PaymentsConfirm400ErrorException object.
        ...
        """
        super(PaymentsConfirm400ErrorException, self).__init__(reason, response)
