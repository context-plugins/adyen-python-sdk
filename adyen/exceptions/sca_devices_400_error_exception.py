...
class ScaDevices400ErrorException(ApiException):
    def __init__(self, reason, response):
        """Initialize ScaDevices400ErrorException object.
        ...
        """
        super(ScaDevices400ErrorException, self).__init__(reason, response)
