...
class DynamicOffersCalculate422ErrorException(ApiException):
    def __init__(self, reason, response):
        """Initialize DynamicOffersCalculate422ErrorException object.
        ...
        """
        super(DynamicOffersCalculate422ErrorException, self).__init__(reason, response)
