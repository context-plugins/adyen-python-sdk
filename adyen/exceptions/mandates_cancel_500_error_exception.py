...
class MandatesCancel500ErrorException(ApiException):
    def __init__(self, reason, response):
        """Initialize MandatesCancel500ErrorException object.
        ...
        """
        super(MandatesCancel500ErrorException, self).__init__(reason, response)
