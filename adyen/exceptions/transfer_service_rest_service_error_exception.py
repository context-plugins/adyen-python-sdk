...
class TransferServiceRestServiceErrorException(APIException):
    def __init__(self, reason, response):
        """Initialize TransferServiceRestServiceErrorException object.
        ...
        """
        super(TransferServiceRestServiceErrorException,
    ...
    def unbox(self, dictionary):
        ...
        self.routing_details = None
        if dictionary.get("routingDetails") is not None:
            self.routing_details = [
                RoutingDetails.from_dictionary(x)
                    for x in dictionary.get("routingDetails")
            ]
        else:
            self.routing_details = None
        self.status =\
