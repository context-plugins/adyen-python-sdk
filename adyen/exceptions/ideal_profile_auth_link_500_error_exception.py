...
class IdealProfileAuthLink500ErrorException(ApiException):
    def __init__(self, reason, response):
        """Initialize IdealProfileAuthLink500ErrorException object.
        ...
        """
        super(IdealProfileAuthLink500ErrorException, self).__init__(reason, response)
