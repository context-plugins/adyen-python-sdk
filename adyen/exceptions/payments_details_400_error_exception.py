...
class PaymentsDetails400ErrorException(ApiException):
    def __init__(self, reason, response):
        """Initialize PaymentsDetails400ErrorException object.
        ...
        """
        super(PaymentsDetails400ErrorException, self).__init__(reason, response)
