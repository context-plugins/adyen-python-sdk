...
class PaymentsDetails422ErrorException(ApiException):
    def __init__(self, reason, response):
        """Initialize PaymentsDetails422ErrorException object.
        ...
        """
        super(PaymentsDetails422ErrorException, self).__init__(reason, response)
