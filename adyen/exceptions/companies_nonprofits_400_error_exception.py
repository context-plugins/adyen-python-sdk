...
class CompaniesNonprofits400ErrorException(ApiException):
    def __init__(self, reason, response):
        """Initialize CompaniesNonprofits400ErrorException object.
        ...
        """
        super(CompaniesNonprofits400ErrorException, self).__init__(reason, response)
