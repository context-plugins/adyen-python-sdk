...
class IdealProfileRegister500ErrorException(ApiException):
    def __init__(self, reason, response):
        """Initialize IdealProfileRegister500ErrorException object.
        ...
        """
        super(IdealProfileRegister500ErrorException, self).__init__(reason, response)
