...
class AuthCertificate500ErrorException(ApiException):
    def __init__(self, reason, response):
        """Initialize AuthCertificate500ErrorException object.
        ...
        """
        super(AuthCertificate500ErrorException, self).__init__(reason, response)
