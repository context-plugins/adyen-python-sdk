...
class MerchantsPaymentsApps400ErrorException(ApiException):
    def __init__(self, reason, response):
        """Initialize MerchantsPaymentsApps400ErrorException object.
        ...
        """
        super(MerchantsPaymentsApps400ErrorException, self).__init__(reason, response)
