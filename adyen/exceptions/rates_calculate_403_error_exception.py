...
class RatesCalculate403ErrorException(ApiException):
    def __init__(self, reason, response):
        """Initialize RatesCalculate403ErrorException object.
        ...
        """
        super(RatesCalculate403ErrorException, self).__init__(reason, response)
