...
class RatesCalculate422ErrorException(ApiException):
    def __init__(self, reason, response):
        """Initialize RatesCalculate422ErrorException object.
        ...
        """
        super(RatesCalculate422ErrorException, self).__init__(reason, response)
