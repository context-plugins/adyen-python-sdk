...
class GrantsDisbursements404ErrorException(ApiException):
    def __init__(self, reason, response):
        """Initialize GrantsDisbursements404ErrorException object.
        ...
        """
        super(GrantsDisbursements404ErrorException, self).__init__(reason, response)
