...
class PaymentsConfirm401ErrorException(ApiException):
    def __init__(self, reason, response):
        """Initialize PaymentsConfirm401ErrorException object.
        ...
        """
        super(PaymentsConfirm401ErrorException, self).__init__(reason, response)
