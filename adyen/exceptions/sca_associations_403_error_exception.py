...
class ScaAssociations403ErrorException(ApiException):
    def __init__(self, reason, response):
        """Initialize ScaAssociations403ErrorException object.
        ...
        """
        super(ScaAssociations403ErrorException, self).__init__(reason, response)
