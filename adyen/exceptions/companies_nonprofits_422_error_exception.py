...
class CompaniesNonprofits422ErrorException(ApiException):
    def __init__(self, reason, response):
        """Initialize CompaniesNonprofits422ErrorException object.
        ...
        """
        super(CompaniesNonprofits422ErrorException, self).__init__(reason, response)
