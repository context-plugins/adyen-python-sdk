...
class DisputesAttachments401ErrorException(ApiException):
    def __init__(self, reason, response):
        """Initialize DisputesAttachments401ErrorException object.
        ...
        """
        super(DisputesAttachments401ErrorException, self).__init__(reason, response)
