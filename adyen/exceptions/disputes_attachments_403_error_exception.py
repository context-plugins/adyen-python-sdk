...
class DisputesAttachments403ErrorException(ApiException):
    def __init__(self, reason, response):
        """Initialize DisputesAttachments403ErrorException object.
        ...
        """
        super(DisputesAttachments403ErrorException, self).__init__(reason, response)
