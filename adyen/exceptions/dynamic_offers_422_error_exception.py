...
class DynamicOffers422ErrorException(ApiException):
    def __init__(self, reason, response):
        """Initialize DynamicOffers422ErrorException object.
        ...
        """
        super(DynamicOffers422ErrorException, self).__init__(reason, response)
