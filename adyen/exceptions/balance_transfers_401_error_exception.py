...
class BalanceTransfers401ErrorException(ApiException):
    def __init__(self, reason, response):
        """Initialize BalanceTransfers401ErrorException object.
        ...
        """
        super(BalanceTransfers401ErrorException, self).__init__(reason, response)
