...
class CheckoutErrorResponseEntityException(ApiException):
    def __init__(self, reason, response):
        """Initialize CheckoutErrorResponseEntityException object.
        ...
        """
        super(CheckoutErrorResponseEntityException, self).__init__(reason, response)
