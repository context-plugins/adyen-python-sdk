...
class BalanceTransfers422ErrorException(ApiException):
    def __init__(self, reason, response):
        """Initialize BalanceTransfers422ErrorException object.
        ...
        """
        super(BalanceTransfers422ErrorException, self).__init__(reason, response)
