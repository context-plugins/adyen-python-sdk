...
class CompaniesNonprofits401ErrorException(ApiException):
    def __init__(self, reason, response):
        """Initialize CompaniesNonprofits401ErrorException object.
        ...
        """
        super(CompaniesNonprofits401ErrorException, self).__init__(reason, response)
