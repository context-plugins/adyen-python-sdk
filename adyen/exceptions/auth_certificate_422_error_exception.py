...
class AuthCertificate422ErrorException(ApiException):
    def __init__(self, reason, response):
        """Initialize AuthCertificate422ErrorException object.
        ...
        """
        super(AuthCertificate422ErrorException, self).__init__(reason, response)
