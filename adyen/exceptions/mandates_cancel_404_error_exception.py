...
class MandatesCancel404ErrorException(ApiException):
    def __init__(self, reason, response):
        """Initialize MandatesCancel404ErrorException object.
        ...
        """
        super(MandatesCancel404ErrorException, self).__init__(reason, response)
