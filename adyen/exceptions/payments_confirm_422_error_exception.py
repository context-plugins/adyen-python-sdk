...
class PaymentsConfirm422ErrorException(ApiException):
    def __init__(self, reason, response):
        """Initialize PaymentsConfirm422ErrorException object.
        ...
        """
        super(PaymentsConfirm422ErrorException, self).__init__(reason, response)
