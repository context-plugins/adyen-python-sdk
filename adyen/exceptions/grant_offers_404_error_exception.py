...
class GrantOffers404ErrorException(ApiException):
    def __init__(self, reason, response):
        """Initialize GrantOffers404ErrorException object.
        ...
        """
        super(GrantOffers404ErrorException, self).__init__(reason, response)
