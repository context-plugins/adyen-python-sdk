...
class MerchantsPaymentsApps500ErrorException(ApiException):
    def __init__(self, reason, response):
        """Initialize MerchantsPaymentsApps500ErrorException object.
        ...
        """
        super(MerchantsPaymentsApps500ErrorException, self).__init__(reason, response)
