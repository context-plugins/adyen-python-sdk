...
class DisputesAttachments422ErrorException(ApiException):
    def __init__(self, reason, response):
        """Initialize DisputesAttachments422ErrorException object.
        ...
        """
        super(DisputesAttachments422ErrorException, self).__init__(reason, response)
