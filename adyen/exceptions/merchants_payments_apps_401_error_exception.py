...
class MerchantsPaymentsApps401ErrorException(ApiException):
    def __init__(self, reason, response):
        """Initialize MerchantsPaymentsApps401ErrorException object.
        ...
        """
        super(MerchantsPaymentsApps401ErrorException, self).__init__(reason, response)
