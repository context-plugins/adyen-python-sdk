...
class DonationPaymentRequest(object):
    ...
    Attributes:
        ...
        shopper_interaction (ShopperInteraction3Enum): Specifies the sales channel,
            ...
            is present (online). For better authorization rates, we recommend sending
            ...
            you can supply also the CSC to improve authorization (one-click payment).
