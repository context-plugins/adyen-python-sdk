...
class PayoutScheduleExecutionDetails(object):
    """Implementation of the 'PayoutScheduleExecutionDetails' model.
    ...
    def __init__(
        ...
        """Initialize a PayoutScheduleExecutionDetails instance."""
