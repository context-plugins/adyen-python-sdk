...
class ActiveNetworkTokensRestriction(object):
    """Implementation of the 'ActiveNetworkTokensRestriction' model.
    ...
    def __init__(
        ...
        """Initialize a ActiveNetworkTokensRestriction instance."""
