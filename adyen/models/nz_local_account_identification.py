...
class NzLocalAccountIdentification(object):
    """Implementation of the 'NZLocalAccountIdentification' model.
    ...
    def __init__(
        ...
        """Initialize a NzLocalAccountIdentification instance."""
