...
class PaymentDetails2(object):
    """Implementation of the 'PaymentDetails2' model.
    ...
    Attributes:
        ...
        sdk_data (str): Base64-encoded JSON object containing SDK related parameters
            required by the SDK
        mtype (Type43): The model property of type Type43.
    ...
    def __init__(
        ...
        """Initialize a PaymentDetails2 instance."""
