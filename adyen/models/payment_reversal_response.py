...
class PaymentReversalResponse(object):
    """Implementation of the 'PaymentReversalResponse' model.
    ...
    Attributes:
        ...
        psp_reference (str): Adyen's 16-character reference associated with the
            reversal request.
        reference (str): Your reference for the reversal request.
    ...
    def __init__(
        ...
        """Initialize a PaymentReversalResponse instance."""
