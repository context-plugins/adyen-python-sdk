...
class Amount42(object):
    """Implementation of the 'Amount42' model.

    For a billing plan where the payment amounts are variable, the minimum amount to
    charge the shopper for each recurring payment. When a shopper approves the
    billing plan, they can also specify a maximum amount in their banking app.
    ...
    def __init__(
        ...
        currency=None,
        value=None):
        """Initialize a Amount42 instance."""
