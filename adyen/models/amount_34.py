...
class Amount34(object):
    """Implementation of the 'Amount34' model.

    An object specifying the currency and value to which you want to convert the
    source amount (the target amount).
    ...
    def __init__(
        ...
        currency=None,
        value=None):
        """Initialize a Amount34 instance."""
