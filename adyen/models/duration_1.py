...
class Duration1(object):
    """Implementation of the 'Duration1' model.

    The duration, which you can specify in hours, days, weeks, or months. The maximum
    duration is 90 days or an equivalent in other units. Required when the `type` is
    **rolling** or **sliding**.
    ...
    def __init__(
        ...
        """Initialize a Duration1 instance."""
