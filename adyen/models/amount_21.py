...
class Amount21(object):
    """Implementation of the 'Amount21' model.

    The upper bound of the processing tier (i.e., an account holder must have
    ...
    def __init__(
        ...
        """Initialize a Amount21 instance."""
