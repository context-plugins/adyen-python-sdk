...
class Blik(object):
    """Implementation of the 'BLIK' model.

    Attributes:
        blik_code (str): BLIK code consisting of 6 digits.
        ...
        stored_payment_method_id (str): This is the `recurringDetailReference`
            returned in the response when you created the token.
        mtype (Type131): The model property of type Type131.
    ...
    def __init__(
        ...
        """Initialize a Blik instance."""
        # Initialize members of the class
        if blik_code is not APIHelper.SKIP:
    ...
    def from_dictionary(cls,
        ...
        blik_code =\
            dictionary.get("blikCode")\
            if dictionary.get("blikCode")\
                else APIHelper.SKIP
        checkout_attempt_id =\
