...
class PaymentInstrument21(object):
    """Implementation of the 'PaymentInstrument21' model.

    Contains information about the payment instrument that was used for the
    transaction.
