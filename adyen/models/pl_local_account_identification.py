...
class PlLocalAccountIdentification(object):
    """Implementation of the 'PLLocalAccountIdentification' model.
    ...
    def __init__(
        ...
        """Initialize a PlLocalAccountIdentification instance."""
