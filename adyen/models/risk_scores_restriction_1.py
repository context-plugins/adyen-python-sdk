...
class RiskScoresRestriction1(object):
    """Implementation of the 'RiskScoresRestriction1' model.

    Risk scores provided by specific sources. The same operation applies to all
    scores.
    ...
    **greaterThan**, **lessThanOrEqualTo**, **lessThan**.
    ...
    Attributes:
        ...
        value (RiskScores): The model property of type RiskScores.
    ...
    def __init__(
        ...
        """Initialize a RiskScoresRestriction1 instance."""
