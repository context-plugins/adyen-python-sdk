...
class CounterpartyInfoV31(object):
    """Implementation of the 'CounterpartyInfoV31' model.

    The other party involved in the funds transfer. A bank account, a balance
    account, a card, or a transfer instrument is required.
    ...
    def __init__(
        ...
        """Initialize a CounterpartyInfoV31 instance."""
