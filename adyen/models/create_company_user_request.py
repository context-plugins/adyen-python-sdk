...
class CreateCompanyUserRequest(object):
    """Implementation of the 'CreateCompanyUserRequest' model.

    Attributes:
        account_groups (List[str]): The list of [account
            groups](https://docs.adyen.com/account/account-structure#account-groups)
            associated with this user.
        associated_merchant_accounts (List[str]): The list of [merchant
    ...
    def __init__(
        ...
        """Initialize a CreateCompanyUserRequest instance."""
