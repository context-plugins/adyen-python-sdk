...
class DuplicateInfo1(object):
    """Implementation of the 'DuplicateInfo1' model.

    Additional information for raising a dispute of `type` **duplicate**. Required
    for disputes of `type` **duplicate**.
