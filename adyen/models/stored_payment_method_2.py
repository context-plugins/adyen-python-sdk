...
class StoredPaymentMethod2(object):
    """Implementation of the 'Stored Payment Method2' model.

    Attributes:
        checkout_attempt_id (str): The checkout attempt identifier.
        issuer (str): The issuer id of the shopper's selected bank.
        ...
        stored_payment_method_id (str): This is the `recurringDetailReference`
            returned in the response when you created the token.
        mtype (Type31Enum): **genericissuer**
    ...
    def __init__(
        ...
        """Initialize a StoredPaymentMethod2 instance."""
