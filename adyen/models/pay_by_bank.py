...
class PayByBank(object):
    """Implementation of the 'PayByBank' model.

    Attributes:
        checkout_attempt_id (str): The checkout attempt identifier.
        issuer (str): The PayByBank issuer value of the shopper's selected bank.
    ...
    def __init__(
        ...
        """Initialize a PayByBank instance."""
