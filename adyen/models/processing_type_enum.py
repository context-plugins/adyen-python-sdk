...
class ProcessingTypeEnum(object):
    """Implementation of the 'ProcessingType' enum.

    The type of transactions processed over this payment method.
     Allowed values:
    - **pos** for in-person payments.
    - **billpay** for subscription payments, both the initial payment and the later
    recurring payments. These transactions have `recurringProcessingModel`
    **Subscription**.
    ...
    **CardOnFile** or **UnscheduledCardOnFile**.
    ...
    Attributes:
        BILLPAY: The enum member of type str.
