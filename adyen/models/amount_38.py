...
class Amount38(object):
    """Implementation of the 'Amount38' model.

    The amount that you want to refund. The `currency` must match the currency used
    ...
    def __init__(
        ...
        currency=None,
        value=None):
        """Initialize a Amount38 instance."""
