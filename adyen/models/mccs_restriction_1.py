...
class MccsRestriction1(object):
    """Implementation of the 'MccsRestriction1' model.
    ...
    Attributes:
        ...
        value (List[str]): List of merchant category codes (MCCs).
    ...
    def __init__(
        ...
        """Initialize a MccsRestriction1 instance."""
