...
class ListTerminalsResponse(object):
    """Implementation of the 'ListTerminalsResponse' model.

    Attributes:
        links (PaginationLinks): The model property of type PaginationLinks.
        data (List[Terminal]): The list of terminals and their details.
    ...
    def __init__(
        ...
        """Initialize a ListTerminalsResponse instance."""
