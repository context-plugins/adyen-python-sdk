...
class PaymentRequest3ds2(object):
    """Implementation of the 'PaymentRequest3ds2' model.
    ...
    Attributes:
        ...
        three_ds_2_result (ThreeDS2Result): The ThreeDS2Result that was returned in
            the final CRes.
        three_ds_2_token (str): The ThreeDS2Token that was returned in the /authorise
            call.
    ...
    _names = {
        ...
        "three_ds_2_token": "threeDS2Token",
    ...
    def __init__(
        ...
        if three_ds_2_token is not APIHelper.SKIP:
            self.three_ds_2_token = three_ds_2_token
    ...
    def from_dictionary(cls,
        ...
        three_ds_2_token =\
            dictionary.get("threeDS2Token")\
            if dictionary.get("threeDS2Token")\
                else APIHelper.SKIP
        three_ds_authentication_only =\
    ...
    def __repr__(self):
        ...
        _three_ds_2_token=(
            self.three_ds_2_token
            if hasattr(self, "three_ds_2_token")
            else None
        )
        ...
        return (
            ...
            f"three_ds_2_token={_three_ds_2_token!r}, "
    ...
    def __str__(self):
        ...
        return (
            ...
            f"three_ds_2_token={_three_ds_2_token!s}, "
