...
class AuthenticationResultRequest(object):
    """Implementation of the 'AuthenticationResultRequest' model.

    Attributes:
        merchant_account (str): The merchant account identifier, with which the
            authentication was processed.
        psp_reference (str): The pspReference identifier for the transaction.
    ...
    def __init__(
        ...
        """Initialize a AuthenticationResultRequest instance."""
