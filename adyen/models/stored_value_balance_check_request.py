...
class StoredValueBalanceCheckRequest(object):
    """Implementation of the 'StoredValueBalanceCheckRequest' model.
    ...
    def __init__(
        ...
        """Initialize a StoredValueBalanceCheckRequest instance."""
