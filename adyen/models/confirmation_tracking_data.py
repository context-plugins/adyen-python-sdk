...
class ConfirmationTrackingData(object):
    ...
    Attributes:
        status (Status110): The model property of type Status110.
        mtype (Type834): The type of the tracking event.  Possible values:   -
        ...
        if isinstance(dictionary, cls):
            return APIHelper.is_valid_type(
                    ...
                    type_callable=lambda value:
                        Status110.validate(value)) \
                and APIHelper.is_valid_type(
                    value=dictionary.mtype,
                    type_callable=lambda value:
                        Type834.validate(value))
