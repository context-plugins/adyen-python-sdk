...
class ListMerchantUsersResponse(object):
    """Implementation of the 'ListMerchantUsersResponse' model.

    Attributes:
        links (PaginationLinks1): Pagination references.
        data (List[User]): The list of users.
    ...
    def __init__(
        ...
        data=APIHelper.SKIP):
        """Initialize a ListMerchantUsersResponse instance."""
