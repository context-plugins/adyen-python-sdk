...
class AdjustAuthTypeEnum(object):
    """Implementation of the 'AdjustAuthType' enum.
    ...
    * **merchantInitiatedTransaction**
    ...
    Attributes:
        CARDHOLDERINITIATEDTRANSACTION: The enum member of type str.
        MERCHANTINITIATEDTRANSACTION: The enum member of type str.
