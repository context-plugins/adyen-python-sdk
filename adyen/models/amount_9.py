...
class Amount9(object):
    """Implementation of the 'Amount9' model.

    The maximum spendable balance for a single transaction. Applicable to some gift
    cards.
