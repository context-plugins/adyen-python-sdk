...
class CounterpartyTypesRestriction1(object):
    """Implementation of the 'CounterpartyTypesRestriction1' model.
    ...
    Attributes:
        ...
        value (List[ValueEnum]): The list of counterparty types to be evaluated.
    ...
    def __init__(
        ...
        """Initialize a CounterpartyTypesRestriction1 instance."""
