...
class PayTo(object):
    """Implementation of the 'PayTo' model.
    ...
    Attributes:
        ...
        sdk_data (str): Base64-encoded JSON object containing SDK related parameters
            required by the SDK
        shopper_account_identifier (str): The shopper's banking details or payId
    ...
    _names = {
        ...
        "sdk_data": "sdkData",
        "shopper_account_identifier": "shopperAccountIdentifier",
    ...
    def __init__(
        ...
        if shopper_account_identifier is not APIHelper.SKIP:
    ...
    def from_dictionary(cls,
        ...
        shopper_account_identifier =\
            dictionary.get("shopperAccountIdentifier")\
            if dictionary.get("shopperAccountIdentifier")\
                else APIHelper.SKIP
        stored_payment_method_id =\
    ...
    def __repr__(self):
        ...
        _shopper_account_identifier=(
            self.shopper_account_identifier
            if hasattr(self, "shopper_account_identifier")
            else None
        )
