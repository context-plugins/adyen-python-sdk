...
class WalletProviderAccountScoreRestriction2(object):
    """Implementation of the 'WalletProviderAccountScoreRestriction2' model.
    ...
    **greaterThan**, **lessThanOrEqualTo**, **lessThan**.
    ...
    def __init__(
        ...
        """Initialize a WalletProviderAccountScoreRestriction2 instance."""
