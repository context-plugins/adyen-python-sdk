...
class StoredPaymentMethod4(object):
    ...
    Attributes:
        ...
        pix_recurring (PixRecurring): The model property of type PixRecurring.
    ...
    def __init__(
        ...
        if pix_recurring is not APIHelper.SKIP:
            self.pix_recurring = pix_recurring
    ...
    def from_dictionary(cls,
        ...
        pix_recurring =\
            PixRecurring.from_dictionary(
                dictionary.get("pixRecurring"))\
                if "pixRecurring" in dictionary.keys()\
                else APIHelper.SKIP
        recurring_detail_reference =\
    ...
    def __repr__(self):
        ...
        return (
            ...
            f"pix_recurring={_pix_recurring!r}, "
    ...
    def __str__(self):
        ...
        return (
            ...
            f"pix_recurring={_pix_recurring!s}, "
