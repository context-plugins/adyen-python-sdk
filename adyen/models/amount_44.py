...
class Amount44(object):
    """Implementation of the 'Amount44' model.

    The updated final payment amount. This amount is the item total plus the shipping
    ...
    def __init__(
        ...
        currency=None,
        value=None):
        """Initialize a Amount44 instance."""
