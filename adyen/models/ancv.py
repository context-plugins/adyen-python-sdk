...
class Ancv(object):
    """Implementation of the 'ANCV' model.

    Attributes:
        beneficiary_id (str): ANCV account identification (email or account number)
        ...
        stored_payment_method_id (str): This is the `recurringDetailReference`
            returned in the response when you created the token.
        mtype (Type51): The model property of type Type51.
    ...
    def from_dictionary(cls,
        ...
        beneficiary_id =\
            dictionary.get("beneficiaryId")\
            if dictionary.get("beneficiaryId")\
                else APIHelper.SKIP
        checkout_attempt_id =\
    ...
    def __repr__(self):
        ...
        _beneficiary_id=(
            self.beneficiary_id
            if hasattr(self, "beneficiary_id")
            else None
        )
        ...
        return (
            ...
            f"beneficiary_id={_beneficiary_id!r}, "
    ...
    def __str__(self):
        ...
        return (
            f"{self.__class__.__name__}("
            f"beneficiary_id={_beneficiary_id!s}, "
