...
class InPersonDonationSettingsResponse(object):
    """Implementation of the 'InPersonDonationSettingsResponse' model.
    ...
    def __init__(
        ...
        """Initialize a InPersonDonationSettingsResponse instance."""
