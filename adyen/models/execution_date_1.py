...
class ExecutionDate1(object):
    """Implementation of the 'ExecutionDate1' model.

    Contains information about the date when the transfer will be processed. The
    execution date must be within 30 days of the current date.
    ...
    def __init__(
        ...
        """Initialize a ExecutionDate1 instance."""
