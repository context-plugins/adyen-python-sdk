...
class PayoutRequest(object):
    ...
    Attributes:
        ...
        billing_address (Address): The address where to send the invoice. > The
            ...
            to and from Canada.
        card (Card): A container for card data. > Either `bankAccount` or `card`
        ...
        fund_source (FundSource11): The person or entity funding the money.
