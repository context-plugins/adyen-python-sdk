...
class Amount43(object):
    """Implementation of the 'Amount43' model.

    For a billing plan where the payment amount is fixed, the amount the shopper will
    be charged for each recurring payment.
    ...
    def __init__(
        ...
        currency=None,
        value=None):
        """Initialize a Amount43 instance."""
