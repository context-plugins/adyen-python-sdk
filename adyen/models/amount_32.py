...
class Amount32(object):
    """Implementation of the 'Amount32' model.
    ...
    different than the request amount if shopper is purchasing items at different
    sub-merchants' shops.
    ...
    def __init__(
        ...
        currency=None,
        value=None):
        """Initialize a Amount32 instance."""
