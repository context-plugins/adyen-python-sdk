...
class GetUploadedDocumentsResponse(object):
    """Implementation of the 'GetUploadedDocumentsResponse' model.

    Attributes:
        document_details (List[DocumentDetail]): A list of the documents and their
            details.
