...
class AdditionalBankIdentification2(object):
    """Implementation of the 'AdditionalBankIdentification2' model.
    ...
    def __init__(
        ...
        """Initialize a AdditionalBankIdentification2 instance."""
