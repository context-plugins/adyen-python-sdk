...
class Amount19(object):
    """Implementation of the 'Amount19' model.

    An object specifying the currency and value for which you want to perform an
    ...
    def __init__(
        ...
        currency=None,
        value=None):
        """Initialize a Amount19 instance."""
