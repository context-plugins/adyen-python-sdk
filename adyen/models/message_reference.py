...
class MessageReference(object):
    """Implementation of the 'MessageReference' model.

    Identification of a previous POI transaction.
    To abort a transaction in progress or to request the status of a transaction from
    which no response has been received. It identifies the message header of the
    message request to abort or request the status.
    ...
    def __init__(
        ...
        """Initialize a MessageReference instance."""
