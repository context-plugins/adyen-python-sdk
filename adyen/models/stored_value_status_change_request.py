...
class StoredValueStatusChangeRequest(object):
    """Implementation of the 'StoredValueStatusChangeRequest' model.
    ...
    Attributes:
        ...
        status (Status6Enum): The status you want to change to
    ...
    def __init__(
        ...
        """Initialize a StoredValueStatusChangeRequest instance."""
