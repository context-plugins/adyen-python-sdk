...
from adyen.models.verification_error_recursive import (
...
class VerificationError(object):
    ...
    Attributes:
        ...
        remediating_actions (List[RemediatingAction]): Contains the actions that you
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get("subErrors") is not None:
            sub_errors = [
                VerificationErrorRecursive.from_dictionary(x)
