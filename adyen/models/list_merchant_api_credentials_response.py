...
class ListMerchantApiCredentialsResponse(object):
    """Implementation of the 'ListMerchantApiCredentialsResponse' model.

    Attributes:
        links (PaginationLinks1): Pagination references.
        data (List[ApiCredential]): The list of API credentials.
    ...
    def __init__(
        ...
        data=APIHelper.SKIP):
        """Initialize a ListMerchantApiCredentialsResponse instance."""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get("data") is not None:
            data = [
                ApiCredential.from_dictionary(x)
