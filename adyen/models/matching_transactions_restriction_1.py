...
class MatchingTransactionsRestriction1(object):
    """Implementation of the 'MatchingTransactionsRestriction1' model.
    ...
    **greaterThan**, **lessThanOrEqualTo**, **lessThan**.
    ...
    Attributes:
        ...
        value (int): The number of transactions.
    ...
    def __init__(
        ...
        """Initialize a MatchingTransactionsRestriction1 instance."""
