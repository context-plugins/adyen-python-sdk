...
class CreateCheckoutSessionResponse(object):
    """Implementation of the 'CreateCheckoutSessionResponse' model.
    ...
    Attributes:
        ...
        date_of_birth (datetime): The shopper's date of birth in
        ...
        session_data (str): The payment session data you need to pass to your front
            end.
        ...
        trusted_shopper (bool): Set to true if the payment should be routed to a
            trusted MID.
        url (str): The URL for the Hosted Checkout page. Redirect the shopper to this
            URL so they can make the payment.
    ...
    def __init__(
        ...
        url=APIHelper.SKIP):
        """Initialize a CreateCheckoutSessionResponse instance."""
        ...
        if session_data is not APIHelper.SKIP:
    ...
    def from_dictionary(cls,
        ...
        session_data =\
            dictionary.get("sessionData")\
            if dictionary.get("sessionData")\
                else APIHelper.SKIP
        shopper_email =\
    ...
    def __repr__(self):
        ...
        return (
            ...
            f"session_data={_session_data!r}, "
    ...
    def __str__(self):
        ...
        return (
            ...
            f"session_data={_session_data!s}, "
