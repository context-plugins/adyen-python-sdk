...
class SourceAccountTypesRestriction1(object):
    """Implementation of the 'SourceAccountTypesRestriction1' model.
    ...
    Attributes:
        ...
        value (List[Value5Enum]): The list of source account types to be evaluated.
    ...
    def __init__(
        ...
        """Initialize a SourceAccountTypesRestriction1 instance."""
