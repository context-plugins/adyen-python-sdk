...
class ListCompanyUsersResponse(object):
    """Implementation of the 'ListCompanyUsersResponse' model.

    Attributes:
        links (PaginationLinks1): Pagination references.
        data (List[CompanyUser]): The list of users.
    ...
    def __init__(
        ...
        data=APIHelper.SKIP):
        """Initialize a ListCompanyUsersResponse instance."""
