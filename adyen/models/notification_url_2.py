...
class NotificationUrl2(object):
    """Implementation of the 'NotificationUrl2' model.

    The list of local and public URLs to send display notifications to when using
    Terminal API.
    ...
    def __init__(
        ...
        """Initialize a NotificationUrl2 instance."""
