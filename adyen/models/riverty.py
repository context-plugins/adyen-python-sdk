...
class Riverty(object):
    """Implementation of the 'Riverty' model.
    ...
    Attributes:
        ...
        device_fingerprint (str): A string containing the shopper's device
            ...
            ng).
        iban (str): The iban number of the customer
        merchant_data (str): Base64-encoded merchant metadata (Extra Merchant Data)
            forwarded to Riverty at authorization.
        ...
        mtype (Type49): The model property of type Type49.
    ...
    def from_dictionary(cls,
        ...
        merchant_data =\
            dictionary.get("merchantData")\
            if dictionary.get("merchantData")\
                else APIHelper.SKIP
        personal_details =\
