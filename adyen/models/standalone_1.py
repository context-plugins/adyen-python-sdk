...
class Standalone1(object):
    """Implementation of the 'Standalone1' model.

    Settings for
    [standalone](https://docs.adyen.com/point-of-sale/standalone/standalone-build/set-
    up-standalone#set-up-standalone-using-an-api-call) features.
    ...
    def __init__(
        ...
        """Initialize a Standalone1 instance."""
