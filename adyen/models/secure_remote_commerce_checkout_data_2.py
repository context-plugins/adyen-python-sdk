...
class SecureRemoteCommerceCheckoutData2(object):
    """Implementation of the 'SecureRemoteCommerceCheckoutData2' model.
    ...
    def __init__(
        ...
        """Initialize a SecureRemoteCommerceCheckoutData2 instance."""
