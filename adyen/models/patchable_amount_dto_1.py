...
class PatchableAmountDto1(object):
    """Implementation of the 'PatchableAmountDTO1' model.

    The balance threshold that triggers the top-up. If the balance falls below this
    amount, a top-up is initiated.
    ...
    def __init__(
        ...
        """Initialize a PatchableAmountDto1 instance."""
