...
class TransactionDescriptionResponseInfo(object):
    """Implementation of the 'TransactionDescriptionResponseInfo' model.
    ...
    def __init__(
        ...
        """Initialize a TransactionDescriptionResponseInfo instance."""
