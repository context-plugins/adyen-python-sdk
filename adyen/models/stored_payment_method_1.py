...
class StoredPaymentMethod1(object):
    """Implementation of the 'StoredPaymentMethod1' model.
    ...
    Attributes:
        ...
        stored_payment_method_id (str): This is the `recurringDetailReference`
            returned in the response when you created the token.
        mtype (Type27): The model property of type Type27.
    ...
    def __init__(
        ...
        """Initialize a StoredPaymentMethod1 instance."""
