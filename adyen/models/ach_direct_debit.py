...
class AchDirectDebit(object):
    """Implementation of the 'ACHDirectDebit' model.

    Attributes:
        account_holder_type (AccountHolderType): The model property of type
            AccountHolderType.
        bank_account_number (str): The bank account number (without separators).
        bank_account_type (BankAccountType): The model property of type
            BankAccountType.
        ...
        mtype (Type9): The model property of type Type9.
