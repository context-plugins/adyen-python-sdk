...
class WalletProviderAccountScoreRestriction(object):
    """Implementation of the 'WalletProviderAccountScoreRestriction' model.
    ...
    def __init__(
        ...
        """Initialize a WalletProviderAccountScoreRestriction instance."""
