...
class TransferNotificationCounterParty(object):
    """Implementation of the 'TransferNotificationCounterParty' model.
    ...
    def __init__(
        ...
        """Initialize a TransferNotificationCounterParty instance."""
