...
from adyen.models.store_detail_response import (
    StoreDetailResponse,
)
from adyen.models.submit_response import SubmitResponse


class InitializationApi(BaseApi):
    """A Controller to access Endpoints in the adyen API."""

    def __init__(self, config):
        """Initialize InitializationApi object."""
        super(InitializationApi, self).__init__(config)

    def post_store_detail(self,
                          body=None):
        """Perform a POST request to /storeDetail.
    ...
    def post_store_detail_and_submit_third_party(self,
                                                 body=None):
        """Perform a POST request to /storeDetailAndSubmitThirdParty.
    ...
    def post_submit_third_party(self,
                                body=None):
        """Perform a POST request to /submitThirdParty.
