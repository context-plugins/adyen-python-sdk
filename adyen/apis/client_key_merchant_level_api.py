...
class ClientKeyMerchantLevelApi(BaseApi):
    ...
    def __init__(self, config):
        """Initialize ClientKeyMerchantLevelApi object."""
        super(ClientKeyMerchantLevelApi, self).__init__(config)
    ...
    def post_merchants_merchant_id_api_credentials_api_credential_id_generate_client_key(self,
        ...
        ow-it-works) for the API credential identified in the path. You can use the
        new client key a few minutes after generating it. The old client key stops
        working 24 hours after generating a new one.
