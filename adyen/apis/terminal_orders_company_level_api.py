...
class TerminalOrdersCompanyLevelApi(BaseApi):
    ...
    def __init__(self, config):
        """Initialize TerminalOrdersCompanyLevelApi object."""
        super(TerminalOrdersCompanyLevelApi, self).__init__(config)

    def get_companies_company_id_billing_entities(self,
                                                  company_id,
                                                  name=None):
        """Perform a GET request to /companies/{companyId}/billingEntities.
    ...
    def get_companies_company_id_shipping_locations(self,
                                                    ...
                                                    offset=None,
                                                    limit=None):
        """Perform a GET request to /companies/{companyId}/shippingLocations.

        Returns the shipping locations for the company identified in the path and all
        merchant accounts belonging to the company.
    ...
    def post_companies_company_id_shipping_locations(self,
                                                     company_id,
                                                     body=None):
        """Perform a POST request to /companies/{companyId}/shippingLocations.
    ...
    def get_companies_company_id_terminal_models(self,
                                                 company_id):
        """Perform a GET request to /companies/{companyId}/terminalModels.

        Returns a list of payment terminal models that the company identified in the
        path has access to.
        The response includes the terminal model ID, which can be used as a query
        parameter when getting a list of terminals or a list of products for ordering.
        To make this request, your API credential must have one of the following
        [roles](https://docs.adyen.com/development-resources/api-credentials#api-permi
        ssions):
        * Management API—Terminal ordering read
    ...
    def get_companies_company_id_terminal_orders(self,
                                                 ...
                                                 offset=None,
                                                 limit=None):
        """Perform a GET request to /companies/{companyId}/terminalOrders.

        Returns a lists of terminal products orders for the company identified in the
        path.
    ...
    def post_companies_company_id_terminal_orders(self,
                                                  company_id,
                                                  body=None):
        """Perform a POST request to /companies/{companyId}/terminalOrders.

        Creates an order for payment terminal products for the company identified in
        the path.
        To make this request, your API credential must have the following
        [role](https://docs.adyen.com/development-resources/api-credentials#api-permis
        sions):
    ...
    def get_companies_company_id_terminal_products(self,
                                                   ...
                                                   offset=None,
                                                   limit=None):
        """Perform a GET request to /companies/{companyId}/terminalProducts.

        Returns a country-specific list of payment terminal packages and parts that
        the company identified in the path has access to.
        ...
        * Management API—Terminal ordering read and write
        ...
        Args:
            ...
            terminal_model_id (str, optional): The terminal model to return products
                ...
                vice/latest/get/companies/{companyId}/terminalModels) response. For
