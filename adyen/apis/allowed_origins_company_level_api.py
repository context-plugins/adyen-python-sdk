...
class AllowedOriginsCompanyLevelApi(BaseApi):
    ...
    def __init__(self, config):
        """Initialize AllowedOriginsCompanyLevelApi object."""
        super(AllowedOriginsCompanyLevelApi, self).__init__(config)
    ...
    def get_companies_company_id_api_credentials_api_credential_id_allowed_origins_origin_id(self,
                                                                                             ...
                                                                                             origin_id):
        """Perform a GET request to
        /companies/{companyId}/apiCredentials/{apiCredentialId}/allowedOrigins/{originI
        d}.
